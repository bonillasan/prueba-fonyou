...
CREATE TABLE `departamentos` (
  ...
  `idPais` int(2) unsigned NOT NULL,
...
INSERT INTO `departamentos` (`id_departamento`, `departamento`, `idPais`)
VALUES
	(5,'ANTIOQUIA',50),
	(8,'ATLÁNTICO',50),
	(11,'BOGOTÁ, D.C.',50),
	...
	(85,'CASANARE',50),
	(86,'PUTUMAYO',50),
	(88,'ARCHIPIÉLAGO DE SAN ANDRÉS, PROVIDENCIA Y SANTA CATALINA',50),
	(91,'AMAZONAS',50),
	(94,'GUAINÍA',50),
	(95,'GUAVIARE',50),
	(97,'VAUPÉS',50),
